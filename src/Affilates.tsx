  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <nav className="bg-white h-24 shadow relative">
        ...
        {/* Second Section */}
        <div className="bg-[#b3e6fa] py-4 px-6 flex justify-center items-center gap-6 text-sm md:text-base font-medium">
            <span className="text-black font-bold">Affiliates</span>
        ...
        <div className="container mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-4 pl-[135px] pr-[80px] py-[10px] text-left float-right">
                Partner for <br />perks
                </h3>
                </div>

                {/* Right Section - col-md-7 equivalent */}
                <div className="md:col-span-7 border-l-2 border-black pl-6">
                <p className="text-sm md:text-base mb-4 text-gray-800">
                    AllTrails affiliates spread the stoke. Tell us how you inspire
                    people to find their way outdoors and earn a commission in return.
                    Apply now. If you're a program match, we'll reach out.
                </p>
        ...
        <section className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div>
                <img
                    src="../assets/images/affiliate1.png"
                    alt="Working"
                ...
                {/* Right Content */}
                <div className="bg-[#FFA869] px-6 py-10">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">How i works</h2>

                {/* Step 1 */}
                <div className="bg-white rounded-md p-4 mb-4 flex">
                    <span className="text-3xl font-bold w-12">01</span>
                    <div className="ml-4">
                    <h3 className="font-semibold text-lg">What is lorem ipsum?</h3>
                ...
                {/* Step 2 - Highlighted */}
                <div className="bg-[#00C7E5] rounded-md p-4 mb-4 flex text-white">
                    <span className="text-3xl font-bold w-12">02</span>
                    <div className="ml-4">
                    <h3 className="font-semibold text-lg">What is lorem ipsum?</h3>
                    <p className="text-sm">
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                ...
                <div className="bg-white rounded-md p-4 flex">
                    <span className="text-3xl font-bold w-12">03</span>
                    <div className="ml-4">
                    <h3 className="font-semibold text-lg">What is lorem ipsum?</h3>
                    <p className="text-sm text-gray-600">
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            ...
            {/* Section 2: More way to work together */}
            <div className="grid grid-cols-1 md:grid-cols-2">
                {/* Left Text Content */}
                <div className="bg-[#B3E6FA] p-10 flex flex-col justify-center">
                <h2 className="text-3xl font-bold mb-6">More way to work together</h2>
                <div className="flex gap-4">
                    <button className="bg-[#00C7E5] text-white px-4 py-2 rounded shadow">Ambassadors</button>
                    <button className="bg-[#00C7E5] text-white px-4 py-2 rounded shadow">Influencers</button>
                </div>
                </div>
                ...
                <div>
                <img
                    src="../assets/images/affiliate2.jpg"
                    alt="Collaboration"
                    className="w-full h-full object-cover"
                />
                </div>
        ...
        <section className="container mx-auto px-4 py-10">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                {/* Full Width Column with Centered Text */}
                <div className="md:col-span-12 text-center">
                <p className="text-2xl md:text-3xl font-semibold">
                    Explore 200+ <br /> national park Guide
                </p>
                </div>
            </div>
        </section>
        ...
        <section className="container mx-auto px-4 py-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                <div className="pr-[5px] pb-[5px] shadow-[4px_4px_10px_rgba(0,0,0,0.25)]">
                <div className="relative">
                    <img
                    src="../assets/images/park_1.png"
                    alt="Zion National Park"
                    className="w-full h-auto object-cover"
                    />
                    <div className="absolute bottom-0 left-0 bg-black/60 text-white p-3 text-sm font-medium w-full">
                    Top Picks in Zion<br />National Park
                    </div>
                </div>
                </div>
