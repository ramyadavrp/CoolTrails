...
const CommunitySection: React.FC = () => {
    ...
    const fetchCommunityData = async () => {
         if (!loginId) return;  // wait until loginId is set
            ...
            const apidata = response.data.data;
             console.log('communitysection',apidata);
    ...
    console.log('ddsssd',getCommunity);
    ...
    const handleDismissedUser = useCallback(async (id: string) => {
        ...
        try {
            ...
            if (response.data.status === "success") {
                setCommunity((prev) => {
                // const updated = prev.filter((item) => item.userId !== id);
                    ...
                    <div className="row">
                        <div className="col-12 px-0 order-xl-first order-lg-first order-md-first order-sm-last order-last">
                            ...
                            <div className="suggested-members-container">
                                ...
                                <div key={getCommunity.length}  className="owl-carousel owl-theme" id="suggestedMembers">
                                    {
                                                      ...
                                                      getSuggestedNearby.length> 0 ?(
                                                        <>
                                                            ...
                                                            // getSuggestedNearby.map((getSug,index)=>(
                                                                <div key={getSug.id} className="single-feed position-relative">
