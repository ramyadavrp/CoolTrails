...
const BlockedUserSection: React.FC = () => {
    ...
    const [errorsCommentFeed,setErrorsCommentFeed] = useState('');
    ...
    useEffect(() => {
        ...
        const loadCommentFeed = async () => {
            ...
            try {
            setloadingCommentFeed(true);
            setErrorsCommentFeed('');
            ...
            if (response.data.status === "success") {
               ...
               setErrorsCommentFeed('Unable to fetch bookmark feed');
                console.error("Error loading profile:", error);
            }finally{
                setloadingCommentFeed(false);
            }
        };
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-xl-9 col-lg-7 col-md-7 col-sm-12 col-12">
                                <DataStateLoading
                                    loading={loadingCommentFeed}
                                    error={errorsCommentFeed || null}
                                    isEmpty={!loadingCommentFeed && getCommentFeed.length === 0}
                                    emptyText="NO Comment Feed found."
                                >
